"""Seed US Core Smoking Status observation (section 2.28) for Alice."""
import asyncio
import json
import asyncpg
...
OBS_ID = "obs-alice-smoking-001"
PROV_ID = "prov-alice-smoking-001"
...
OBSERVATION = {
    ...
    "text": {
        "status": "generated",
        "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\">Tobacco smoking status: Never smoked tobacco</div>"
    },
    "status": "final",
    "category": [
        {
