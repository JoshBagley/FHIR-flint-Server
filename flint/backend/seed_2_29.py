"""Seed US Core Observation Sexual Orientation (section 2.29) for Alice."""
import asyncio
import json
import asyncpg
...
OBS_ID = "obs-alice-sexual-orientation-001"
PROV_ID = "prov-alice-sexual-orientation-001"
...
OBSERVATION = {
    ...
    "text": {
        "status": "generated",
        "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\">Sexual orientation: Heterosexual</div>"
    },
    "status": "final",
    "category": [
        {
