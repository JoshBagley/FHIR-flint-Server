"""Seed US Core Pediatric Weight for Height observation (section 2.26) for Alice."""
import asyncio
import json
import asyncpg
...
OBS_ID = "obs-alice-peds-wt-height-001"
PROV_ID = "prov-alice-peds-wt-height-001"
...
OBSERVATION = {
    ...
    "effectiveDateTime": "2015-06-15T10:30:00Z",
    ...
    "text": {
        "status": "generated",
        "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\">Weight-for-length Per age and sex: 65%</div>"
    }
}
