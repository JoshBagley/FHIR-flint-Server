"""Seed US Core Pediatric Head Occipital-Frontal Circumference Percentile (section 2.37) for Alice.

Two observations covering all must-support elements:
  - obs-alice-hc-pct-normal : valueQuantity (head circumference percentile)
  - obs-alice-hc-pct-absent : dataAbsentReason
"""
import asyncio
import json
import asyncpg
...
NORMAL_ID = "obs-alice-hc-pct-normal"
ABSENT_ID = "obs-alice-hc-pct-absent"
PROV_ID   = "prov-alice-hc-pct"
...
NORMAL = {
    **COMMON,
    ...
    "text": {
        "status": "generated",
        "div": "<div xmlns=\"http://www.w3.org/1999/xhtml\">Head circumference percentile: 50%</div>"
    },
